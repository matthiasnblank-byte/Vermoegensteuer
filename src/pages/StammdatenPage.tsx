        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 text-sm"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3">
            ...
            />
            <span className="text-sm text-gray-700">Vollst?ndigkeitserkl?rung</span>
          </label>
          <label className="flex items-center gap-3">
            <input
              type="checkbox"
              ...
              className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-600"
            />
            <span className="text-sm text-gray-700">Mitwirkungspflichten erf?llt</span>
          </label>
          <label className="flex items-center gap-3">
            <input
              type="checkbox"
              ...
              className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-600"
            />
            <span className="text-sm text-gray-700">Einwilligung Datenverarbeitung</span>
          </label>
        </div>
